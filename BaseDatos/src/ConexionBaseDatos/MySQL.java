...
public class MySQL {
    ...
    public ArrayList<ArrayList<Object>> Resultados = new ArrayList<>();
    public ArrayList<Object> Datos = new ArrayList<>();
    public ArrayList<Object[]> resulset = new ArrayList<>();
    ...
    public void Comandos(String cad) {
        try {
            stmt = (Statement) conexion.getConn().createStatement();
            stmt.execute(cad);
            stmt.close();
